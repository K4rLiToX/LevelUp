...
sealed class StringResource(@StringRes val resId: Int) {
    ...
    object CompleteSetError : StringResource(R.string.error_set_not_completed)
    object CompleteExercisesError : StringResource(R.string.error_exercises_sets_not_completed)
    ...
    object KgUnilateral : StringResource(R.string.placeholder_weight_unilateral)
    object Reps : StringResource(R.string.placeholder_reps)
